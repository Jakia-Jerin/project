          ...
          child: Column(
            children: [
              FTextField(
                ...
                hint: '+8801XXXXXXXXX',
                onChange: (val) => controller.phone.value = val,
              ),
              FTextField(
                label: const Text("Line 1 *"),
                controller: line1Controller,
                hint: 'ex. House 12, Road 7, Nasirabad Housing Society',
                onChange: (val) => controller.line1.value = val,
              ),

              FTextField(
                label: const Text("Region "),
                controller: regionController,
                hint: 'Please input Region',
                onChange: (val) => controller.region.value = val,
              ),
              ...
              FTextField(
                ...
                onChange: (val) => controller.district.value = val,
              ),

              FTextField(
                label: const Text("Post Code *"),
                controller: postcodeController,
                hint: 'Please input Post Code',
                onChange: (val) => controller.postcode.value = val,
              ),
              ...
              FTextField(
                ...
                hint: 'ex. Bangladesh',
                onChange: (val) => controller.country.value = val,
              ),
              // FTextField(
              //   label: const Text("District "),
              //   controller: districtController,
              ...
              FButton(
                ...
                onPress: () {
                  ...
                  //       : null,
                  //   district: districtController.text.isNotEmpty
