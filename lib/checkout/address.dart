        ...
        return FTileGroup(
            ...
            children: [
              FTile(
                  ...
                  subtitle: selected.line2 != null &&
                          selected.line2!.trim().isNotEmpty
                      ? Text(
                          maxLines: 5,
                          "${selected.line2!},${selected.district}, ${selected.region}, ${selected.postcode}, ${selected.addressType.tr.toUpperCase()}",
