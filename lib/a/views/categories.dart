...
//                       return FTile(
//                         onPress: () async {
//                           //    categoriesController.handleCategoryTap(category);
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                FButton.icon(
                  onPress: () {
                    categoriesController.selectCategoryItems(null);
                  },
                  child: FIcon(
                    FAssets.icons.chevronLeft,
                    size: 28,
                          ...
                          children: categoriesController.selectedCategoryItems
                            ...
                            return FTile(
                              ...
                              prefixIcon: ClipRRect(
                                ...
                                child: Image.network(
                                  category.imageUrl != null
                                      ? '$baseurl/image/$shop/${category.imageUrl!.imageName}'
                                      : 'https://via.placeholder.com/50',
                                  fit: BoxFit.cover,
                                  width: 50,
                                  height: 50,
                            ...
                            return GestureDetector(
                              onTap: () {
                                ...
                                print(
                                    "*************************************************");
                                print(
                                    "Selected categories count: ${categoriesController.selectedCategoryItems.length}");
                                if (!hasRoot) {
                                  Get.toNamed("/search", parameters: {
                                    "category": category.handle
                                  });
